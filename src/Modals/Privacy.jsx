  ...
  return (
    <Modal show={show} onHide={handleClose} animation={false} className='mainclass'>
      ...
      <Modal.Body>
        ...
        <p>This privacy policy applies to the Hands App app (hereby referred to as "Application") for mobile devices that was created by Hands International (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
        ...
        <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to Email, Phone number, ID proof, Gender, Location, Bank Details. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>

        <p className='fw-bold'>Third Party Access</p>
        <p>
        ...
        <ul>
          <li>
            <a href="https://www.google.com/policies/privacy/" className=' text-primary' target="_blank" rel="noopener noreferrer">
              Google Play Services
            </a>
          </li>
          <li>
            <a href="https://firebase.google.com/support/privacy" className=' text-primary' target="_blank" rel="noopener noreferrer">
        ...
        <p className='fw-bold'>Opt-Out Rights</p>
        <p>You can stop all collection of information by the Application easily by uninstalling it. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.</p>

        <p className='fw-bold'>Data Retention Policy</p>
        <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at admin@handsappuae.com and they will respond in a reasonable time.</p>
        ...
        <p>
          The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider (admin@handsappuae.com) so that they will be able to take the necessary actions.
        ...
        <p>This privacy policy is effective as of 2024-08-03</p>
        ...
        <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at <a href="mailto:admin@handsappuae.com" className='text-primary'> admin@handsappuae.com
        </a></p>
