...
function UseModals({ show, handleClose }) {
  ...
  return (
    <Modal show={show} onHide={handleClose} animation={false} className='mainclass'>
      ...
      <Modal.Body>
        ...
        <p>We are Hands International App ('Company', 'we', 'us', or 'our'), a company registered in the United Arab Emirates.</p>

        <p>We operate the mobile application Hands App (the 'App'), as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').</p>

        <p>You can contact us by email at <a href="mailto:admin@handsappuae.com" className='text-primary'>
          admin@handsappuae.com</a> or by mail <a href="mailto:toinfo@handsappuae.com" className=' text-primary' target="_blank" rel="noopener noreferrer">toinfo@handsappuae.com</a>, Abu Dhabi, United Arab Emirates.</p>

        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and Hands International App, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

        <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by info@handsappuae.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
        ...
        <h4>We recommend that you print a copy of these Legal Terms for your records.</h4><br />
        ...
        <br />
        <h4>2. INTELLECTUAL PROPERTY RIGHTS</h4><br />
        <h5>Our intellectual property</h5><br />
        <p>We are the owner or the licensee of all intellectual property rights in our Services, including
        ...
        <p>Subject to your compliance with these Legal Terms, including the 'PROHIBITED
          ...
          to: admin@handsappuae.com. If we ever grant you the permission to post, reproduce, or
          ...
          Terms and your right to use our Services will terminate immediately.</p><br />
        ...
        <p>Please review this section and the 'PROHIBITED ACTIVITIES' section carefully prior to using
          ...
          or upload any content through the Services.</p><br />
        <p><h6>Submissions:</h6> By directly sending us any question, comment, suggestion, idea, feedback, or other
          ...
          acknowledgment or compensation to you.</p><br />
        <p>
          <h6>Contributions:</h6> The Services may invite you to chat, contribute to, or participate in blogs,
          message boards, online forums, and other functionality during which you may create, submit,
          post, display, transmit, publish, distribute, or broadcast content and materials to us or through the
        ...
        <p><h6>When you post Contributions, you grant us a licence (including use of your name,trademarks, and logos):</h6> By posting any Contributions, you grant us an unrestricted, unlimited,
          irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right,
          and licence to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store,
          publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit
          ...
          works, your Contributions, and to sublicence the licences granted in this section. Our use and
          ...
          images you provide.</p><br />
        <p><h6>You are responsible for what you post or upload:</h6> By sending us Submissions and/or posting
          ...
          relation to your Submissions and/or Contributions; and <br />
          ...
          expressly agree to reimburse us for any and all losses that we may suffer because
          of your breach of (a) this section, (b) any third party’s intellectual property rights,
          or (c) applicable law.</p><br />
        <p><h5>We may remove or edit your Content:</h5> Although we have no obligation to
          ...
          you to the authorities.</p> <br />
        <p><h5>Copyright infringement</h5>
          ...
          INFRINGEMENTS' section below.</p><br />
        <p><h4>3. USER REPRESENTATIONS</h4> <br />
          ...
          or unauthorised purpose; and (8) your use of the Services will not violate any applicable law or
          regulation.
          ...
          any portion thereof).</p><br />
        <p><h4>4. USER REGISTRATION</h4><br />
          Yu may be required to register to use the Services. You agree to keep your password confidential
          ...
          inappropriate, obscene, or otherwise objectionable.</p><br />
        <p><h4>5. PURCHASES AND PAYMENT</h4><br />
          ...
          change prices at any time. All payments shall be in AED.
        ...
        <p><h4>7. PROHIBITED ACTIVITIES</h4><br />
          ...
          commercial endeavours except those that are specifically endorsed or approved by us. <br />
          ...
          without written permission from us. <br />
          • Trick, defraud, or mislead us and other users, especially in any attempt to learn
          sensitive account information such as user passwords.  <br />
          ...
          • Sell or otherwise transfer your profile.</p><br />
        <p><h4>8. USER GENERATED CONTRIBUTIONS</h4>
          ...
          be viewable by other users of the Services and through third-party websites. As such, any Contributions
          you   transmit   may   be   treated   as   non-confidential   and   non-proprietary.   When   you   create   or   make
          available any Contributions, you thereby represent and warrant that: <br />
          ...
          by the Services and these Legal Terms. <br />
          ...
          person and to promote violence against a specific person or class of people. <br />
          ...
          these Legal Terms, or any applicable law or regulation. <br />
          Any use of the Services in violation of the foregoing violates these Legal Terms and may result in,
          among other things, termination or suspension of your rights to use the Services.</p> <br />
        <p><h4>9. CONTRIBUTION LICENCE</h4>
          ...
          worldwide right, and licence to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast,
          ...
          incorporate into other works, such Contributions, and grant and authorise sublicences of the
          foregoing. The use and distribution may occur in any media formats and through any media channels. <br />
          ...
          asserted in your Contributions. <br />
          ...
          against us regarding your Contributions. <br />
          ...
          notice. We have no obligation to monitor your Contributions.</p><br />
        <p><h4>10. GUIDELINES FOR REVIEWS</h4>
          ...
          conduct; (7) you may not post any false or misleading statements; and (8) you may not organise a
          campaign encouraging others to post reviews, whether positive or negative. <br /> <br />
          ...
          exclusive, worldwide, royalty-free, fully paid, assignable, and sublicensable right and licence to
          reproduce, modify, translate, transmit by any means, display, perform, and/or distribute all content
          relating to review.</p><br />
        <p><h4>11. MOBILE APPLICATION LICENCE</h4>
          <h5>Use Licence</h5>
          ...
          and conditions of this mobile application licence contained in these Legal Terms. You shall not: (1)
          ...
          applications, accessories, or devices for use with the App. <br /> <br />
          <h6>Apple and Android Devices</h6>
          The following terms apply when you use the App obtained from either the Apple Store or Google
          Play (each an 'App Distributor') to access the Services: (1) the licence granted to you for our App is
          limited to a non-transferable licence to use the application on a device that utilises the Apple iOS or
          ...
          application licence contained in these Legal Terms or as otherwise required under applicable law, and
          ...
          application licence contained in these Legal Terms, and that each App Distributor will have the right
          (and will be deemed to have accepted the right) to enforce the terms and conditions in this mobile
          application licence contained in these Legal Terms against you as a third-party beneficiary thereof.</p><br />
        <p><h4>12. SOCIAL MEDIA</h4>
          ...
          Party Account (the 'Social Network Content') so that it is available on and through the Services via
          ...
          unavailable or our access to such Third-Party Account is terminated by the third-party service
          provider, then Social Network Content may no longer be available on and through the Services. You
          will have the ability to disable the connection between your account on the Services and your Third-
          ...
          associated with your account.</p> <br />
        <p><h4>13. SERVICES MANAGEMENT</h4>
          ...
          our rights and property and to facilitate the proper functioning of the Services.</p><br />
        <p><h4>14. PRIVACY POLICY</h4>
          ...
          Services are hosted in the United Arab Emirates and United Arab Emirates. If you access the
          Services from any other region of the world with laws or other requirements governing personal data
          collection, use, or disclosure that differ from applicable laws in the United Arab Emirates and United
          Arab Emirates, then through your continued use of the Services, you are transferring your data
          to the United Arab Emirates and United Arab Emirates, and you expressly consent to have your data
          transferred to and processed in the United Arab Emirates and United Arab Emirates.</p> <br />
        <p><h4>15. COPYRIGHT INFRINGEMENTS</h4>
          ...
          the Services infringes your copyright, you should consider first contacting an attorney.</p><br />
        <p><h4>16. TERM AND TERMINATION</h4>
          ...
          AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. <br />
        ...
        <p><h4>17. MODIFICATIONS AND INTERRUPTIONS</h4>
          ...
          modification, price change, suspension, or discontinuance of the Services. <br />
          ...
          corrections, updates, or releases in connection therewith.</p> <br />
        <p><h4>18. GOVERNING LAW</h4>
          These Legal Terms shall be governed by and defined following the laws of the United Arab
          Emirates. Hands International App and yourself irrevocably consent that the courts
          of the United Arab Emirates shall have exclusive jurisdiction to resolve any dispute
          which may arise in connection with these Legal Terms.</p><br />
        <p><h4>19. DISPUTE RESOLUTION</h4>
          You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship
          established by these Legal Terms to the jurisdiction of the United Arab Emirates courts. Hands
          International App shall also maintain the right to bring proceedings as to the substance of the
          matter in the courts of the country where you reside or, if these Legal Terms are entered into in
          the course of your trade or profession, the state of your principal place of business.</p> <br />
        <p><h4>20. CORRECTIONS</h4>
        ...
        <p><h4>21. DISCLAIMER</h4>
          ...
          BEST JUDGEMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</p> <br />
        <p><h4>23. INDEMNIFICATION</h4>
        ...
        <p><h4>24. USER DATA</h4>
          ...
          such data.</p><br />
        <p><h4>25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h4>
          ...
          records, or to payments or the granting of credits by any means other than electronic means.</p> <br />
        <p><h4>26. SMS TEXT MESSAGING</h4>
          <h6>Opting Out</h6>
          If at any time you wish to stop receiving SMS messages from us, simply reply to the text with
          "STOP.” You may receive an SMS message confirming your opt out. <br />
          <h6>Message and Data Rates</h6>
          Please be aware that message and data rates may apply to any SMS messages sent or received.
          The rates are determined by your carrier and the specifics of your mobile plan. <br />
          <h6>Support</h6>
          If you have any questions or need assistance regarding our SMS communications, please email us
          at admin@handsappuae.com.</p><br />
        <p><h4>27. MISCELLANEOUS</h4>
          ...
          parties hereto to execute these Legal Terms.</p> <br />
        <p><h4>28. CONTACT US</h4>
          In order to resolve a complaint regarding the Services or to receive further information
          regarding use of the Services, please contact us at: <br />
          Hands International App <br />
          Downtown, Abu Dhabi 00000 <br />
          United Arab Emirates <br />
          admin@handsappuae.com</p>
