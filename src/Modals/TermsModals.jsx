  ...
  return (
    <Modal show={show} onHide={handleClose} animation={false} className='mainclass'>
      ...
      <Modal.Body>
        ...
        <p>These terms and conditions apply to the Hands App app (hereby referred to as "Application") for mobile devices that was created by Hands International (hereby referred to as "Service Provider") as a Free service.</p>
        <br />
        ...
        <ul>
          <li>
            <a href="https://policies.google.com/terms" className=' text-primary' target="_blank" rel="noopener noreferrer">
              Google Play Services
            </a>
          </li>
          <li>
            <a href="https://www.google.com/analytics/terms/" className=' text-primary' target="_blank" rel="noopener noreferrer">
        ...
        <p className='fw-bold'>Changes to These Terms and Conditions</p>
        ...
        <p>These terms and conditions are effective as of 2024-08-03</p>




        <p className='fw-bold'>Contact Us</p>
        <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:admin@handsappuae.com" className='text-primary'>admin@handsappuae.com</a></p>
